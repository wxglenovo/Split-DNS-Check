...
def process_part(part, all_rules_set=None):
    ...
    if all_rules_set is None:
        all_rules_set = download_all_sources()
...
if __name__ == "__main__":
    ...
    if args.part:
        process_part(args.part, all_rules_set)
    else:
